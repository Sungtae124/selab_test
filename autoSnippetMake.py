...
def main():
    ...
    try:
        remote_dir = '/data/bug_db/subjects/defects4j/Lang-57'
        ...
        prompt = (
            f"Given the following directories and files from the defect4j dataset Lang-57:\n"
            f"Result directory files: {result_files}\n"
            f"Test directory files: {test_files}\n"
            f"Write a Python script that reads the following relevant files from the server: diff_Lang-57.txt, coverage.json, npe.traces.json, tests.json, and files in the result directory.\n"
            f"The script must process these files and generate three json file,snippet.json, field_snippet.json, and test_snippet.json. "
            ...
            f"# Note that below files can be replaced with another bug data files. You have to find proper files!\n"
            f"field_snippets = extract_field_info(buggy_file_lines, 'org.apache.commons.lang.text.StrBuilder', 'src/java/org/apache/commons/lang/text/StrBuilder.java') + extract_field_info(fixed_file_lines, 'org.apache.commons.lang.text.StrBuilder', 'src/java/org/apache/commons/lang/text/StrBuilder.java')\n"
        ...
        print("Generated script saved to generated_script.py")
